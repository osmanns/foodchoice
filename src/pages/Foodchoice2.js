...
function Foodchoice2() {
    ...
    const getItems = async () => {
        ...
        const response = await Axios.get('//159.65.133.73/api/stage', {
            ...
            setRecords(response.data.stage_2.reverse())
        }).catch((error) => {
        ...
        <>
            <TabPanel value={value} index={0}>
                <Toolbar>
                    ...
                    />
                    <span className="box-data-count">ข้อมูลรอการยืนยัน จำนวนทั้งหมดในระบบ : {dataCount} รายการ</span>
                </Toolbar>
                <TbContainer>
                    <TbHead />
                    <TableBody>
